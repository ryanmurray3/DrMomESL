...
function checkAnswers() {
  ...
  for (let id in correctAnswers) {
    ...
    if (userAnswer === correctAnswer) {
      feedback += `<p class="correct">Answer for question ${
        id.split("-")[1]
      } is correct!</p>`;
      document.getElementById(id).style.backgroundColor = "green";
      document.getElementById(id).style.color = "white";
    } else {
      feedback += `<p class="incorrect">Answer for question ${
        id.split("-")[1]
      } is incorrect. The correct answer is ${correctAnswer}.</p>`;
...
document
  .getElementById("submit-button-ex2")
  .addEventListener("click", checkAnswersEx2);
...
// Add event listener to the reset button
document
  .getElementById("reset-button-ex2")
...
document
  .getElementById("submit-button-ex3")
  .addEventListener("click", checkPossessiveAnswers);
document
  .getElementById("reset-button-ex3")
  .addEventListener("click", resetPossessiveAnswers);
...
function checkPossessiveAnswers() {
  ...
  for (let id in possessiveCorrectAnswers) {
    ...
    if (selectedOption) {
      ...
      if (userAnswer === correctAnswer) {
        possessiveFeedback += `<p class="correct">Answer for question ${
          id.split("-")[1]
        } is correct!</p>`;
        selectedOption.style.backgroundColor = "green";
        selectedOption.style.color = "white";
      } else {
        possessiveFeedback += `<p class="incorrect">Answer for question ${
          id.split("-")[1]
        } is incorrect. The correct answer is ${correctAnswer}.</p>`;
      ...
      possessiveFeedback += `<p class="incorrect">Answer for question ${
        id.split("-")[1]
      } is missing. Please select an answer.</p>`;
    }
  }
...
document
  .getElementById("submit-button-ex4")
  .addEventListener("click", checkPossessiveAdjectivesEx4);
document
  .getElementById("reset-button-ex4")
  .addEventListener("click", resetPossessiveAdjectivesEx4);
...
function checkPossessiveAdjectivesEx4() {
  ...
  for (let id in possessiveAdjectivesAnswersEx4) {
    ...
    if (userAnswer === correctAnswer) {
      feedbackEx4 += `<p class="correct">Answer for input ${
        id.split("-")[2]
      } is correct!</p>`;
      document.getElementById(id).style.backgroundColor = "green";
      document.getElementById(id).style.color = "white";
    } else {
      feedbackEx4 += `<p class="incorrect">Answer for input ${
        id.split("-")[2]
      } is incorrect. The correct answer is ${correctAnswer}.</p>`;
      document.getElementById(id).style.backgroundColor = "red";
      document.getElementById(id).style.color = "white";
...
function resetPossessiveAdjectivesEx4() {
  ...
  const inputElements = document.querySelectorAll(
    '#more-possessive-adjectives-section input[type="text"]'
  );
  inputElements.forEach((input) => {
    input.value = ""; // Clear the value
    input.style.backgroundColor = ""; // Reset background color
...
document
  .getElementById("submit-button-A")
  .addEventListener("click", checkReviewExerciseA);
document
  .getElementById("reset-button-A")
  .addEventListener("click", resetReviewExerciseA);
...
function checkReviewExerciseA() {
  ...
  for (let id in correctAnswersA) {
    ...
    if (userAnswerA === correctAnswerA) {
      feedbackA += `<p class='correct'>Answer for question ${
        id.split("-")[2]
      } is correct!</p>`;
      document.getElementById(id).style.backgroundColor = "green";
      document.getElementById(id).style.color = "white";
    } else {
      feedbackA += `<p class='incorrect'>Answer for question ${
        id.split("-")[2]
      } is incorrect. The correct answer is ${correctAnswerA}.</p>`;
      document.getElementById(id).style.backgroundColor = "red";
      document.getElementById(id).style.color = "white";
    }
  }
...
function resetReviewExerciseA() {
  const inputElementsA = document.querySelectorAll(
    '.review-exercise-A input[type="text"]'
  );
...
document
  .getElementById("submit-button-B")
  .addEventListener("click", checkReviewExerciseB);
document
  .getElementById("reset-button-B")
  .addEventListener("click", resetReviewExerciseB);
  ...
  for (let id in correctAnswersB) {
    ...
    if (selectedOptionB) {
      ...
      if (userAnswerB === correctAnswerB) {
        feedbackB += `<p class='correct'>Answer for question ${
          id.split("-")[2]
        } is correct!</p>`;
        selectedOptionB.style.backgroundColor = "green";
        selectedOptionB.style.color = "white";
      } else {
        feedbackB += `<p class='incorrect'>Answer for question ${
          id.split("-")[2]
        } is incorrect. The correct answer is ${correctAnswerB}.</p>`;
...
function resetReviewExerciseB() {
  const optionElementsB = document.querySelectorAll(
    ".review-exercise-B .option"
  );
